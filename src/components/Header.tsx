  ...
  return (
    <header>
      <div className='container mx-auto flex justify-between items-center px-4 py-2'>
        <div className='mr-4'>
          <Link to={'/'} className='text-2xl font-Tienne font-semibold'>
            Logo
            {/* <img src='path_to_your_logo_image' alt='Logo' className='h-10' /> */}
          </Link>
        </div>
        <div className='hidden md:flex flex- justify-center items-center'>
            ...
            <div key={navigation.name} className='relative'>
              {navigation.subServices ? (
                <div
                  ...
                  className='mx-4 hover:text-orange relative group font-semibold'
                >
          ...
          <button className='ml-8 hidden md:inline-block bg-orange hover:bg-blue-600 text-white px-5 py-2 rounded hover:opacity-80 hover:shadow-lg'>
            Let's Connect
          </button>
        </div>
